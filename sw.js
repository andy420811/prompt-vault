...
"use strict";
const CACHE = "pv-shell-v5";   // 換名字＝強制重新安裝並重建整包快取（改動 sw.js 內容時記得也換）
const ASSETS = [
  "./",
  "./index.html",
  "./css/pv-style.css",
  "./js/data/pv-vocab.js",
  "./js/data/pv-seed.js",
  "./js/data/pv-library.js",
  "./js/canvas/pv-canvas.js",
  "./video.html",
  "./css/video.css",
  "./js/video/video-app.js",
  "./js/vault/pv-app-core.js",
  "./js/vault/pv-app-stacks.js",
  "./js/vault/pv-app-render.js",
  "./js/vault/pv-app-interact.js",
  "./js/vault/pv-app-analyze.js",
  "./js/vault/pv-app-editor.js",
  "./js/vault/pv-app-apply.js",
  "./js/vault/pv-app-inspire.js",
  "./js/vault/pv-app-aitools.js",
  "./js/vault/pv-app-board.js",
  "./js/vault/pv-app-gen.js",
  "./js/vault/pv-app-sem.js",
  "./js/vault/pv-app-tree.js",
  "./js/vault/pv-app-kanban.js",
  "./js/vault/pv-app-share.js",
  "./js/vault/pv-app-stats.js",
  "./js/vault/pv-app-suggest.js",
  "./js/vault/pv-app-boot.js",
